...
/// @notice - internal - only inside the contract that inherits an internal function
/// @notice - external - only other contracts and accounts can call
/// @notice - State variables can be declared as public, private, or internal but not external.
