...
/// @title Solidity Signature Replay
/// @author solidity by example
/// @notice Signing messages off-chain and having a contract that requires that signature before executing a function is a useful technique.
...
/// @notice sign messages with nonce and address of the contract and mark tx hash as executed
