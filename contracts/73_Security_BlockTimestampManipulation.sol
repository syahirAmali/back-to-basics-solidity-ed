...
/// @title Solidity Block Timestamp Manipulation
/// @author solidity by example
/// @notice block.timestamp can be manipulated by miners with the followin constraints
...
/// @notice dont use block.timestamp for a source of entropy and random number