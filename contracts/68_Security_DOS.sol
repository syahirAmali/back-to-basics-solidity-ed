...
/// @title Solidity Denial of Service
/// @author solidity by example
/// @notice There are many ways to attack a smart contract to make it unusable.
...
/// @notice allow the users to withdraw their Ether instead of sending it.
