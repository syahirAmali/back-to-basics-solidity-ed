...
/// @title Hiding Malicious code within External Contract
/// @author solidity by example
/// @notice In Solidity any address can be casted into specific contract, even if the contract at the address is not the one being casted.
...
/// @notice - initialize a new contract inside the constructor
