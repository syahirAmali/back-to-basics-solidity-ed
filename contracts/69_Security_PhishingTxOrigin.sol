...
/// @title Solidity Phishing with tx.origin
/// @author solidity by example
/// @notice What's the difference between msg.sender and tx.origin?
...
/// @notice use msg.sender instead of tx.origin

// function transfer2(address payable _to, uint256 _amount) public {
